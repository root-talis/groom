...
use syn::{Error, Item, ItemEnum, ItemStruct};
...
/// Generates `#[DTO]` from an enum
fn generate_impl_for_enum(_args_t: TokenStream, args: DtoArgs, item_enum: ItemEnum) -> TokenStream {
